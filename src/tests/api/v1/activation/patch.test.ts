...
import { clearDB, createUser, webserverUrl } from "src/tests/orchestrator";
...
describe("PATCH /api/v1/activation", () => {
  describe("Anonymous user", () => {
    test("Activating with blank body", async () => {
      const response = await fetch(`${webserverUrl}/api/v1/activation`, {
        method: "patch",
      });
    ...
    //   expect(responseBody.name).toEqual("ValidationError");
    //   expect(responseBody.message).toEqual(
    //     '"token_id" deve ser do tipo String.'
    //   );
    //   expect(responseBody.action).toEqual(
    //     "Ajuste os dados enviados e tente novamente."
    //   );
    ...
    //   expect(responseBody.name).toEqual("ValidationError");
    //   expect(responseBody.message).toEqual(
    //     '"token_id" não pode estar em branco.'
    //   );
    //   expect(responseBody.action).toEqual(
    //     "Ajuste os dados enviados e tente novamente."
    //   );
    ...
    //   expect(responseBody.name).toEqual("ValidationError");
    //   expect(responseBody.message).toEqual(
    //     '"token_id" deve possuir um token UUID na versão 4.'
    //   );
    //   expect(responseBody.action).toEqual(
    //     "Ajuste os dados enviados e tente novamente."
    //   );
    ...
    //   expect(activationToken.expires_at - activationToken.created_at).toBe(
    //     900000
    //   ); // 15 minutes
    ...
    //   const firstTryResponde = await fetch(
    //     `${webserverUrl}/api/v1/activation`,
    //     {
    //       method: "patch",
    //       headers: {
    //         "Content-Type": "application/json",
    ...
    //   const secondTryResponde = await fetch(
    //     `${webserverUrl}/api/v1/activation`,
    //     {
    //       method: "patch",
    //       headers: {
    ...
    //   expect(Date.parse(activationToken.updated_at)).not.toEqual(NaN);
    //   expect(
    //     secondTryRespondeBody.updated_at > secondTryRespondeBody.created_at
    //   ).toBe(true);
    ...
    //   );
    //   expect(responseBody.action).toEqual(
    //     "Faça login novamente para receber um novo token por email."
    //   );
    //   expect(uuidVersion(responseBody.error_id)).toEqual(4);
    //   expect(uuidVersion(responseBody.request_id)).toEqual(4);
    //   expect(responseBody.error_location_code).toEqual(
    //     "MODEL:ACTIVATION:FIND_ONE_VALID_TOKEN_BY_ID:NOT_FOUND"
    //   );
    //   expect(responseBody.key).toEqual("token_id");
    // });
  });
  ...
  //     let defaultUser = await createUser();
  //     defaultUser = await activateUserwebserverUrl(defaultUser);
  //     const activationToken = await activation.create(defaultUser);
  ...
  //     expect(responseBody.message).toEqual(
  //       "Você não pode mais ler tokens de ativação."
  //     );
  //     expect(responseBody.action).toEqual(
  ...
  //     defaultUser = await activateUserwebserverUrl(defaultUser);
  //     const activationToken = await activation.create(defaultUser);
  //     let defaultUserSession = await createSessiowebserverUrln(defaultUser);
  ...
  //     );
  //     expect(responseBody.action).toEqual(
  //       'Verifique se este usuário possui a feature "read:activation_token".'
  //     );
  //     expect(uuidVersion(responseBody.error_id)).toEqual(4);
  //     expect(uuidVersion(responseBody.request_id)).toEqual(4);
  //     expect(responseBody.error_location_code).toEqual(
