...
describe("POST /api/v1/users/createUsers", () => {
  describe("Anonymous user", () => {
    test("With unique and valid data", async () => {
      const response = await fetch(`${webserverUrl}/api/v1/users/CreateUser`, {
        method: "post",
        headers: {
    ...
    test('With "email" duplicated (same uppercase letters)', async () => {
      await fetch(`${webserverUrl}/api/v1/users/CreateUser`, {
        method: "post",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      const secondResponse = await fetch(
        `${webserverUrl}/api/v1/users/CreateUser`,
        {
          method: "post",
          headers: {
            "Content-Type": "application/json",
